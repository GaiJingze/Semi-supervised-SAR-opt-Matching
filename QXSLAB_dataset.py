...
class QXSLAB_dataset(Dataset):
    def __init__(self, image_size_1, image_size_2, dataset_path="data/QXSLAB_SAROPT", random_seed = 42, data_range = range(0, 282384)):
    ...
    def init_img_pair_infos(self):
        ...
        for img_idx in range(0, 20001):
            sar_img_path = f'{self.dataset_path}/sar_256_oc_0.2/{img_idx}.png'
            opt_img_path = f'{self.dataset_path}/opt_256_oc_0.2/{img_idx}.png'
...
def test():
    train_dataset = QXSLAB_dataset((256, 256), (192, 192), data_range=range(0, 16000))
    test_dataset = QXSLAB_dataset((256, 256), (192, 192), data_range=range(16000, 20000))
